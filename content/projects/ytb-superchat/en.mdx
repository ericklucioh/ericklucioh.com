...
<Callout title="Important separation" tone="warning">
	The repository documents two session concepts: one that links the extension to
	the dashboard, and another for the overlay itself. That separation prevents
	local capture flow and OBS display flow from overwriting each other.
</Callout>
