...
<Callout title="Goal" tone="info">
	The system helps maintenance technicians interpret critical turbine
	variables and suggest the next step using rule-based reasoning.
</Callout>
...
<MetricGrid>
	<MetricCard
		label="Variables"
		value="11"
		detail="wind, rpm, vibration, temperature, pressure, and consumption"
	/>
	<MetricCard
		label="Diagnoses"
		value="8+"
		detail="rules focused on common operational failures"
	/>
	<MetricCard
		label="Output"
		value="Explainable"
		detail="every result includes a reason and a suggested action"
	/>
	<MetricCard
		label="Format"
		value="Static"
		detail="content is versioned in Git and published without a backend"
	/>
</MetricGrid>
